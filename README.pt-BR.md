...
> [!NOTE]
> **Vem mais melhoria por aí.** Estou trabalhando ativamente em novos recursos e correções. As próximas já estão na [1.5.0-beta.8](https://github.com/lippdev/consolemode/releases/tag/v1.5.0-beta.8). Sua opinião define o que vem depois: use o **botão de feedback** no aplicativo ou [envie seu feedback aqui](https://github.com/lippdev/consolemode/issues/new?template=feedback.yml). Veja [Feedback](#feedback).
