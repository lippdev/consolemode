...
## [Unreleased]
### What's new
- Holding the controller's Xbox button for 1 second while the app is in the tray enters console mode without touching the PC. Xbox (XInput) controllers only; it can be turned off in Settings.
