...
> [!NOTE]
> **More improvements are on the way.** I'm actively working on new features and fixes. The next ones are already in [1.5.0-beta.7](https://github.com/lippdev/consolemode/releases/tag/v1.5.0-beta.7). Your opinion shapes what comes next: use the **feedback button** in the app or [send feedback here](https://github.com/lippdev/consolemode/issues/new?template=feedback.yml). See [Feedback](#feedback).
...
## Latest release: [1.5.0-beta.7](https://github.com/lippdev/consolemode/releases/tag/v1.5.0-beta.7)
